...
# Function to send e-mail via AWS SES using boto3
...
def lambda_handler(event, context):
    ...
    # Filter data and attributes, nested inside body.
    a = b['data']['attributes']
    ...
    # Send e-mail and return results from send_email()
    return send_email('from@from.com', 'to@to.com', 'us-east-1', 'SMS from ' + fromnumber, fromnumber, tonumber, a['body'], a['timestamp'])
